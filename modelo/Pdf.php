...
function getHtml($id_venta){
    ...
    <header class="clearfix">
        ...
        <div id="company" class="clearfix">
            <div id="negocio">Farmacia Farmaciasistema</div>
            <div>Direccion Numero ###,<br /> Ciudad, Provincia</div>
            <div>(344) 342234</div>
            <div><a href="mailto:company@example.com">company@exaple.com</a></div>
        </div>';
    ...
    <main>
        <table>
            ...
            <div id="notices">
                <div>NOTICE:</div>
                <div class="notice">*Presentar este comprobante de pago para cualquier reclamo o devolucion.</dip>
            ...
            <footer>
                Created by Farmaciasistema (Alejandro, Josue, Junior, Enzo) Ingenieros de sistemas e informatica.
            </footer>
            </body>';
    return $plantilla;
}